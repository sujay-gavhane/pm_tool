            ...
            s = this.each(function() {
                ...
                !this.sumo && e(this).is("select") && (this.sumo = {
                    ...
                    toggSel: function(t, l) {
                        var i, s = this;
                        "number" == typeof l ? (s.vRange(l), i = s.E.find("option")[l]) : i = s.E.find('option[value="' + l + '"]')[0] || 0, i && !i.disabled && i.selected != t && (i.selected = t, s.mob || e(i).data("li").toggleClass("selected", t), s.setPstate(), s.setText(), s.selAllState())
                    },
